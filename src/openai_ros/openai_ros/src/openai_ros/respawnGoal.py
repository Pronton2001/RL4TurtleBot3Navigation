...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('src/RL4TurtleBot3Navigation/src/openai_ros/openai_ros/src/openai_ros',
                                                'src/turtlebot3_simulations/turtlebot3_gazebo/models/turtlebot3_square/goal_box/model.sdf')
